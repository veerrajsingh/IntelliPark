...
cap=cv2.VideoCapture('C:/Users/Veer Raj/Desktop/ParkingDetector/ParkingDetector/parking1.mp4')
if not cap.isOpened():
    print("Error: Could not open video.")

my_file = open("C:/Users/Veer Raj/Desktop/ParkingDetector/ParkingDetector/coco.txt","r")
data = my_file.read()
